...
String setupBLEList[NUM_SETUPOPERATIONS_BLE] = {"AT+IMME0", "AT+ROLE0", "AT+NAMEmeter1", "AT+NOTI1", "AT+NOTP1", "AT+ADTY0", "AT+BAUD0", "AT+ADVI1", "AT+SHOW3", "AT+RESET"};
...
enum State {INIT, RESET, SETUP_BLE, BLE_ADV, BLE_MASTER}; // State Alias
const char * const stateName[] PROGMEM = {"INIT", "RESET", "SETUP_BLE", "BLE_ADV", "BLE_MASTER"}; // Helper for print labels instead integer when state change
