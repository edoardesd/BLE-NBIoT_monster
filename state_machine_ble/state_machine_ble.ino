...
#define CONNECTION_TIME 60000
#define ADV_TIME 60000
#define DELAY_MESSAGES_BLE 10000
...
const char *const stateName[] PROGMEM = { "INIT", 
                                          ...
                                          "BLE_MASTER", 
                                          "BLE_CONNECTED", 
                                          "BLE_DISCONNECTION" };  // Helper for print labels instead integer when state change
...
void setupStateMachine() {
  ...
  stateMachine.AddState(stateName[BLE_MASTER], wakeUp, onMaster, onExit);
