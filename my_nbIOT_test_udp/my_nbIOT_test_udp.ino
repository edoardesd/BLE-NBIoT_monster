...
#elif defined(VODAFONE_IT)
const char* apn = "nb.inetd.gdsp";
const char* cdp = "IP";
uint8_t cid = 0;
const uint8_t band = 20; //5 8 20 28
// 5 failed immediatly
// 8 takes time + IP failed + cid 0/1 failed
// 20 takes time + IP failed + cid 0/1 failed
// 28 failed
...
#elif defined(VODAFONE_IT)
    int lengthSent = nbiot.socketSend(socketID, "131.175.120.220", 8883, strBuffer);  
#endif
