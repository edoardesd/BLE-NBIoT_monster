...
enum State {INIT, RESET, SETUP_BLE, BLE_MASTER, BLE_CONNECTED}; // State Alias
const char * const stateName[] PROGMEM = {"INIT", "RESET", "SETUP_BLE", "BLE_MASTER", "BLE_CONNECTED"}; // Helper for print labels instead integer when state change
